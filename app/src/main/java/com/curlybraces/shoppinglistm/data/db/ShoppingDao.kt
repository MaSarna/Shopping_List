...
interface ShoppingDao {
    ...
    @Query("SELECT * FROM shopping_items WHERE shopping_list_id = :listId ORDER BY item_timestamp DESC")
    fun getAllShoppingItems(listId: Long): LiveData<List<ShoppingItem>>
}